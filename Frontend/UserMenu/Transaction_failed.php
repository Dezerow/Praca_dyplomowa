        ...
        <section class="row justify-content-center">
            <section class="col-12 col-sm-6 col-md-6 mt-5">
                <div class="card-block text-center bg-light">
                    <label id="Title">
                        <h1 style=" text-align: center; color:red">Transakcja anulowana</h1>
                    </label>
                    <div class="form-group mt-5">
                        <h3>Transakcja została anulowana, wykonaj ją po raz kolejny lub wróć do przeglądania witryny.</h3>
                    </div>
                    <div class="mt-4">
