        ...
        <div class="d-flex justify-content-center">
            <div class="card-block text-center bg-light" style="width:500px">
                ...
                <div class="text-start mt-5 ms-3">
                    ...
                    <div>
                        <div class="mt-5 ms-0">
                            <h3 class="mt-5 ms-2">Edycja administratora: <?php echo $Username ?></h3>
                        ...
                        <form method="POST" action="../../../Praca_dyplomowa/Backend/Server/backAdminEditAdmin.php">
                            ...
                            <div class="collapse" id="pokazNazweUzytkownika">
                                <div class="row mt-4">
                                    ...
                                    <div class="col mt-1"><input type="text" placeholder="<?php echo $Username ?>" maxlength="15" name="newUsername" required></div>
                        ...
                        <form method="POST" action="../../../Praca_dyplomowa/Backend/Server/backAdminEditAdmin.php">
                            <div class="mt-3">
                                <button class="btn btn-primary" type="button" data-bs-toggle="collapse" data-bs-target="#pokazEdycjeStanu" aria-expanded="false" aria-controls="collapseExample">
                                    Zmień stan konta administratora
                                </button>
                            </div>
                        ...
                        <form method="POST" action="../../../Praca_dyplomowa/Backend/Server/deleteAdmin.php">
                            <div class="mt-3">
                            ...
                            <div class="collapse" id="pokazUsuwanie">
                                <div class="row mt-4">
                                    ...
                                    <div class="col mt-0">
                                        <select class="form-select" name="deleteAdmin" id="ConfirmDelete" required onchange="enableDelete()">
